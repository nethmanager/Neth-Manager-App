                    ...
                    <div className="md:col-span-2 space-y-3">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 bg-black/20 p-4 rounded-2xl border border-white/5">
                        {[
                          ...
                          { id: 'update_project', label: 'Update Projects' },
                          { id: 'delete_project', label: 'Delete Projects' },
                          { id: 'update_expense', label: 'Update Expenses' },
                          { id: 'delete_expense', label: 'Delete Expenses' },
                          { id: 'update_contact', label: 'Update Contacts' },
                          { id: 'delete_contact', label: 'Delete Contacts' },
                          { id: 'create_calendar_event', label: 'Create Calendar Events' },
                          { id: 'update_calendar_event', label: 'Update Calendar Events' },
                          { id: 'delete_calendar_event', label: 'Delete Calendar Events' },
                    ...
                    <div className="md:col-span-2 space-y-3">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 bg-black/20 p-4 rounded-2xl border border-white/5">
                        {[
                          ...
                          { id: 'update_project', label: 'Require Approval to Update Projects' },
                          { id: 'delete_project', label: 'Require Approval to Delete Projects' },
                          { id: 'update_expense', label: 'Require Approval to Update Expenses' },
                          { id: 'delete_expense', label: 'Require Approval to Delete Expenses' },
                          { id: 'update_contact', label: 'Require Approval to Update Contacts' },
                          { id: 'delete_contact', label: 'Require Approval to Delete Contacts' },
                          { id: 'create_calendar_event', label: 'Require Approval to Create Calendar Events' },
                          { id: 'update_calendar_event', label: 'Require Approval to Update Calendar Events' },
                          { id: 'delete_calendar_event', label: 'Require Approval to Delete Calendar Events' },
                          { id: 'update_task', label: 'Require Approval to Update Tasks' },
                          { id: 'delete_task', label: 'Require Approval to Delete Tasks' },
